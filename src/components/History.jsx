...
const History = (props) => {
    ...
    return (
      <div className={`flex flex-col gap-2 md:w-[200px] sm:w-[100%] border cursor-pointer rounded-xl h-[130px] bg-bg4 border-blue-500 transition-all  duration-500 ease-in-out hover:scale-105 active:scale-95 overflow-hidden  ${props.contentShow? '' : 'opacity-0 scale-0'}`}
